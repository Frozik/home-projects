...
`,ct=_.memo(()=>{const f=_.useMemo(()=>({uTime:{value:0},uCount:{value:1e5}}),[]);return Ae((p,b)=>{f.uTime.value+=b}),z.jsxs("mesh",{children:[z.jsx("instancedBufferGeometry",{instanceCount:f.uCount.value,drawRange:{start:0,count:3}}),z.jsx("shaderMaterial",{side:Qe,glslVersion:$e,uniforms:f,fragmentShader:st,vertexShader:rt})]})}),lt="_container_15fkn_1",ut={container:lt},ft=_.memo(()=>z.jsx("div",{className:ut.container,children:z.jsxs(Je,{camera:{position:[0,0,10]},scene:{background:new et("#262626")},children:[z.jsx(ct,{}),z.jsx(it,{})]})}));export{ft as Sun};
