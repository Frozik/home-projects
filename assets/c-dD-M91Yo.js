import{r as n,J as t,i as f,u as x}from"./e-Ccls8iNJ.js";import{c as s,D as u,G as v,O as h,C as m,d as w}from"./c-DrHKhySt.js";import{c as B}from"./c-CCiIKx5L.js";const l=`
...
`,g=n.memo(()=>{const e=n.useMemo(()=>({uCount:{value:4},uSize:{value:new Float32Array([window.innerWidth,window.innerHeight])}}),[]);return s(({viewport:i})=>{e.uSize.value[0]=Math.max(0,i.width-20),e.uSize.value[1]=Math.max(0,i.height-20)}),t.jsxs("mesh",{children:[t.jsx("instancedBufferGeometry",{instanceCount:e.uCount.value,drawRange:{start:0,count:6*3}}),t.jsx("shaderMaterial",{side:u,glslVersion:v,uniforms:e,fragmentShader:d,vertexShader:P})]})}),p=n.memo(()=>{const e=n.useMemo(()=>({uTime:{value:0},uCount:{value:1},uSize:{value:new Float32Array([window.innerWidth,window.innerHeight])},uPenSize:{value:new Float32Array([2,20])}}),[]),i=n.useRef(null);return s((r,o)=>{e.uTime.value+=o,e.uSize.value[0]=r.viewport.width-4*e.uPenSize.value[1],e.uSize.value[1]=r.viewport.height-4*e.uPenSize.value[1],e.uCount.value=Math.trunc(r.viewport.width/e.uPenSize.value[1]/4)*4+1,f(i.current)||(i.current.instanceCount=e.uCount.value)}),t.jsxs("mesh",{children:[t.jsx("instancedBufferGeometry",{ref:i,instanceCount:e.uCount.value,drawRange:{start:0,count:6*3}}),t.jsx("shaderMaterial",{side:u,glslVersion:v,uniforms:e,fragmentShader:d,vertexShader:A})]})}),V=n.memo(()=>{const e=n.useRef(null),{width:i=0,height:r=0}=x({ref:e,box:"border-box"}),o=n.useMemo(()=>new h(0,0,0,0,-1e3,1e3),[]);return n.useEffect(()=>{const a=i/2,c=r/2;o.left=-a,o.right=a,o.top=c,o.bottom=-c,o.updateProjectionMatrix()},[o,i,r]),t.jsx("div",{ref:e,className:B.fixedContainer,children:t.jsxs(m,{orthographic:!0,camera:o,scene:{background:new w("#262626")},children:[t.jsx(g,{}),t.jsx(p,{})]})})});export{V as Charts};
