...
`,ct=S.memo(()=>{const f=S.useMemo(()=>({uTime:{value:0},uCount:{value:1e5}}),[]);return Ae((p,b)=>{f.uTime.value+=b}),z.jsxs("mesh",{children:[z.jsx("instancedBufferGeometry",{instanceCount:f.uCount.value,drawRange:{start:0,count:3}}),z.jsx("shaderMaterial",{side:Qe,glslVersion:$e,uniforms:f,fragmentShader:rt,vertexShader:lt})]})}),ft=S.memo(()=>z.jsx("div",{className:tt.fixedContainer,children:z.jsxs(Je,{camera:{position:[0,0,10]},scene:{background:new et("#262626")},children:[z.jsx(ct,{}),z.jsx(st,{})]})}));export{ft as Sun};
