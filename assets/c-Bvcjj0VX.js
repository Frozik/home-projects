...
`,ut=L.memo(()=>{const f=L.useMemo(()=>({uTime:{value:0},uCount:{value:1e5}}),[]);return Ie((h,b)=>{f.uTime.value+=b}),k.jsxs("mesh",{children:[k.jsx("instancedBufferGeometry",{instanceCount:f.uCount.value,drawRange:{start:0,count:3}}),k.jsx("shaderMaterial",{side:$e,glslVersion:Je,uniforms:f,fragmentShader:lt,vertexShader:ct})]})}),bt=L.memo(()=>k.jsx("div",{className:ot.fixedContainer,children:k.jsxs(et,{camera:{position:[0,0,10]},scene:{background:new tt("#262626")},children:[k.jsx(ut,{}),k.jsx(rt,{minDistance:5,maxDistance:20})]})}));export{bt as Sun};
