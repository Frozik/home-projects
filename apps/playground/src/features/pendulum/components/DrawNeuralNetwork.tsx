...
} from '../../../libs/pendulum/players/defs';
import { ELayerType, ENeuronLayerType } from '../../../libs/pendulum/players/defs';
...
export const DrawNeuralNetwork = memo(() => {
    ...
    useEffect(() => {
        ...
        for (const drawingObject of drawingObjects) {
            ...
            switch (type) {
                ...
                case ELayerType.Axon: {
                    const isSelected =
                        selectedNeuron?.id === drawingObject.from ||
